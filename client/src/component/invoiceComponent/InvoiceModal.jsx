...
class InvoiceModal extends React.Component {
  ...
  render() {
    return(
      <div>
        <Modal show={this.props.showModal} onHide={this.props.closeModal} size="lg" centered className='text-gray-800'>
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              <div className="w-100">
                <h2 className="fw-bold my-2">Riejom Chemicals Industry Limited</h2>
                <h5 className='my-2'>Head Office: No.291 Aba-Owerri Road, Abayi, Aba</h5>
                <h5 className='my-2'>Email: riejomchem@yahoo.com</h5>
                <h5 className='my-2'>Website: riejomchemicals.com.ng</h5>
                <h5 className='my-2'>Phone: 08035523918, 08038952412</h5>
                <br/>
